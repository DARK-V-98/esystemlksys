...
export function BillPreviewDialog({ isOpen, setIsOpen, billData, onFinalizeAndSave, isUserLoggedIn }: BillPreviewDialogProps) {
    ...
    const {
        ...
        taxAmount,
        total,
        type = 'Invoice' // Default to 'Invoice'
    } = currentBillData;
    ...
    const downloadPDF = async (dataForPdf: BillData) => {
        ...
        try {
            ...
            pdf.save(`${docType}-${dataForPdf.invoiceNumber}.pdf`);
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent className="max-w-4xl h-[90vh] flex flex-col">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Review your {type.toLowerCase()} before saving and downloading.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div ref={billPreviewRef} className="relative p-8 bg-white text-black shadow-lg w-[8.5in] min-h-[11in] mx-auto">
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <div className="text-right">
                                <h2 className="text-3xl font-bold uppercase">{type}</h2>
                        ...
                        <div className="flex justify-between mb-8">
                            <div>
                                <h3 className="font-bold mb-1">{type === 'Quotation' ? 'Quote For:' : 'Bill To:'}</h3>
                            ...
                            <div className="text-right">
                                ...
                                <p><span className="font-bold">{type === 'Quotation' ? 'Valid Until:' : 'Due Date:'}</span> {dueDate}</p>
                            </div>
                        </div>
                        ...
                        <div className="absolute bottom-4 left-0 right-0 text-center text-xs text-gray-400">
                            Generated by ESYSTEMLK {type} Generator
                        </div>
                    </div>
                </div>
                <DialogFooter>
