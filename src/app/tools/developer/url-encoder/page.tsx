...
import { ArrowLeft, Link2, RefreshCw, Clipboard, Check, ArrowRightLeft } from 'lucide-react';
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-primary-foreground">
              URL <span className="text-primary neon-text">Encoder/Decoder</span>
            </h1>
      ...
      <div className="bg-card rounded-lg border shadow-sm p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
            <div className="space-y-4">
                 <h2 className="text-lg font-semibold">Input ({mode === 'encode' ? 'Decoded' : 'Encoded'})</h2>
                 <Textarea
                    placeholder={`Enter ${mode === 'encode' ? 'text' : 'encoded URL component'}...`}
                    value={input}
            ...
            <div className="space-y-4">
                 <h2 className="text-lg font-semibold">Output ({mode === 'encode' ? 'Encoded' : 'Decoded'})</h2>
